* ====================================================================
* SMF TYPE 79 SUBTYPE 7 — Enqueue contention data
...
* --- section SMF79_SUBTYPE7_PRODUCT_SECTION via SMF79PRS ---
...
* --- section SMF79_SUBTYPE7_MONITOR_2_CONTROL_SECTION via SMF79MCS ---
