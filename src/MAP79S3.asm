* ====================================================================
* SMF TYPE 79 SUBTYPE 3 — Storage/processor data
...
* --- section SMF79_SUBTYPE3_PRODUCT_SECTION via SMF79PRS ---
...
* --- section SMF79_SUBTYPE3_MONITOR_2_CONTROL_SECTION via SMF79MCS ---
