* ====================================================================
* SMF TYPE 79 SUBTYPE 1 — Address space state data
...
* --- section SMF79_SUBTYPE1_PRODUCT_SECTION via SMF79PRS ---
...
* --- section SMF79_SUBTYPE1_MONITOR_2_CONTROL_SECTION via SMF79MCS ---
