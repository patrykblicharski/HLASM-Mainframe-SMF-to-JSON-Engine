* ====================================================================
* SMF TYPE 79 SUBTYPE 5 — Address space SRM data
...
* --- section SMF79_SUBTYPE5_PRODUCT_SECTION via SMF79PRS ---
...
* --- section SMF79_SUBTYPE5_MONITOR_2_CONTROL_SECTION via SMF79MCS ---
