...
* --- section via SMF119S1Off ---
         SMF_FIELD SMF119IS_IFActualMtu-SMF119IS_IFActualMtu,TRIPLET=SMF119S1Off-SMF119LEN,        X
               TYPE=T_DEC4,JSON=isifactualmtu

         SMF_FIELD SMF119IS_IFSPeed-SMF119IS_IFActualMtu,TRIPLET=SMF119S1Off-SMF119LEN,        X
               TYPE=T_DEC4,JSON=isifspeed

         SMF_FIELD SMF119IS_IFHSpeed-SMF119IS_IFActualMtu,TRIPLET=SMF119S1Off-SMF119LEN,        X
               TYPE=T_DEC4,JSON=isifhspeed

         SMF_FIELD SMF119IS_IFInDisc-SMF119IS_IFActualMtu,TRIPLET=SMF119S1Off-SMF119LEN,        X
               TYPE=T_DEC4,JSON=isifindisc

         SMF_FIELD SMF119IS_IFInError-SMF119IS_IFActualMtu,TRIPLET=SMF119S1Off-SMF119LEN,        X
               TYPE=T_DEC4,JSON=isifinerror

         SMF_FIELD SMF119IS_IFInUProt-SMF119IS_IFActualMtu,TRIPLET=SMF119S1Off-SMF119LEN,        X
               TYPE=T_DEC4,JSON=isifinuprot

         SMF_FIELD SMF119IS_IFOutDisc-SMF119IS_IFActualMtu,TRIPLET=SMF119S1Off-SMF119LEN,        X
               TYPE=T_DEC4,JSON=isifoutdisc

         SMF_FIELD SMF119IS_IFOutError-SMF119IS_IFActualMtu,TRIPLET=SMF119S1Off-SMF119LEN,        X
               TYPE=T_DEC4,JSON=isifouterror

         SMF_FIELD SMF119IS_IFOQL-SMF119IS_IFActualMtu,TRIPLET=SMF119S1Off-SMF119LEN,        X
               TYPE=T_DEC4,JSON=isifoql
